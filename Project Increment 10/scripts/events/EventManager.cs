...
public static class EventManager
{
    ...
    static List<UnityAction<DifficultyType, GameType>> gameStartedListeners = 
    new List<UnityAction<DifficultyType, GameType>>();
    ...
    public static void AddGameStartedInvoker(GameStartingMenu invoker)
    {
        ...
        foreach (UnityAction<DifficultyType, GameType> listener in gameStartedListeners)
        {
            invoker.AddGameStartedListener(listener);
        }
    }

    public static void AddGameStartedListener(UnityAction<DifficultyType, GameType> listener)
    {
