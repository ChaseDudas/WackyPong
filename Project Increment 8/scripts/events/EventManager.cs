...
public static class EventManager
{
    ...
    // player won support
    static List<HUD> playerWonAddedInvokers = new List<HUD>();
    static List<UnityAction<ScreenSide, int>> playerWonAddedListeners =
        new List<UnityAction<ScreenSide, int>>();
    ...
    /// <summary>
    /// Adds the player won invoker.
    /// </summary>
    /// <param name="invoker">Invoker.</param>
    public static void AddPlayerWonInvoker(HUD invoker)
    {
        playerWonAddedInvokers.Add(invoker);
        foreach (UnityAction<ScreenSide, int> listener in playerWonAddedListeners)
        {
    ...
    /// </summary>
    /// <param name="listener">Listener.</param>
    public static void AddPlayerWonListener(UnityAction<ScreenSide, int> listener)
    {
        playerWonAddedListeners.Add(listener);
        foreach (HUD invoker in playerWonAddedInvokers)
        {
            invoker.AddPlayerWonListener(listener);
        }
    }
