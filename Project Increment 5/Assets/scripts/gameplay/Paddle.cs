...
public class Paddle : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if(frozen) //Dont let player move if frozen
        {
            return;
        }
    ...
    //public void Freeze(ScreenSide scSide, int duration)
    //{
    ...
    //    if (leftPaddle.side != scSide)
    //    {
    //        leftPaddle.FreezePaddleForDuration(duration);
    //    }
    //    else
    //    {
    //        rightPaddle.FreezePaddleForDuration(duration);
    //    }
    //}

    public void FreezePaddleForDuration(int duration)
    {
        if(frozen)
        {
            freezeEffect.Add(duration);
        }
        else
        {
        ...
        freezeEffect.Run();
        //Change bool to true so paddles wont work
        frozen = true;
    }
