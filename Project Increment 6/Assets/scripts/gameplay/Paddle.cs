...
public class Paddle : MonoBehaviour
{
    ...
    protected HitsAddedEvent hitPointsAdded = new HitsAddedEvent();
    ...
    void Start()
    {
        ...
        EventManager.AddListenerP(Freeze);
    }
    ...
    void Update()
    {
        // unfreeze paddle when freeze timer finishes
    ...
    public void AddHitPointsAdded(UnityAction<ScreenSide, int> listener)
    {
        hitPointsAdded.AddListener(listener);
    }
