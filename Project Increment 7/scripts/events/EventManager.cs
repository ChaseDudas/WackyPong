...
public static class EventManager
{
    ...
    // pickup effect support
    static List<Pickup> speedupEffectActivatedInvokers = new List<Pickup>();
    static List<UnityAction<ScreenSide, float>> speedupEffectActivatedListeners =
        new List<UnityAction<ScreenSide, float>>();
    ...
    #region Pickup effect activated support
    ...
    public static void AddSpeedupEffectActivatedInvoker(Pickup invoker)
    {
        ...
        foreach (UnityAction<ScreenSide, float> listener in speedupEffectActivatedListeners)
        {
    ...
    /// <summary>
    /// Adds the given method as a pickup effect activated listener
    /// </summary>
    /// <param name="listener">listener</param>
    public static void AddSpeedupEffectActivatedListener(UnityAction<ScreenSide, float> listener)
    {
